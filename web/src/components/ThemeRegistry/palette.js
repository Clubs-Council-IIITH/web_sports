...
const palette = {
  light: {
    ...
    mode: "light",
    text: { primary: GREY[900], secondary: GREY[800], disabled: GREY[600], light: GREY[300], lighter: GREY[100], menu: "#004720", opposite: "#fff"  },
    background: { paper: "#A6CF98", default: "#E0F2FF", neutral: "#E0F2FF", menu: "#004720" },
  ...
  dark: {
    ...
    background: { paper: GREY[800], default: "#111111", neutral: GREY[500_16], menu: "#e74c3c" },
